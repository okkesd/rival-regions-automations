...
url1 = "https://rivalregions.com/storage/market/11"
url2 = "https://rivalregions.com/storage/sell/11"
...
span = soup_main.find("span", class_="storage_number_change", attrs={'url': '11'}).text
...
if (kimin == f"slide/profile/{rr_id}" or market_fiyati < 1250): # bizim ya da fiyat dusuk
    ...
    if (ekle_or_degistir == "m"):
        ...
        if (offre_inp < 15360000 and offre_inp+depodaki < 15360000):
            miktar = offre_inp+depodaki
        else: miktar = 15360000
    ...
    'method': 'POST',
    'path': f'/storage/newsell/11/{miktar}/{fiyat}',
    'scheme': 'https',
    'Accept' : 'text/html, */*; q=0.01',
    'Accept-Encoding' : 'gzip, deflate, br, zstd',
    'Accept-Language' : 'tr-TR,tr;q=0.9,en-US;q=0.8,en;q=0.7,fr;q=0.6',
    ...
    url3 = "https://rivalregions.com/storage/newsell/11/" + str(miktar) + "/" + str(fiyat)
