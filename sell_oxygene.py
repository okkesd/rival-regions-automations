...
url1 = "https://rivalregions.com/storage/market/21"
url2 = "https://rivalregions.com/storage/sell/21"
...
span = soup_main.find("span", class_="storage_number_change", attrs={'url': '21'}).text
depodaki = int(span.replace(".",""))
print("Depoda bulunan: ",depodaki)
if (depodaki == 0):
    print("Stop")
    sys.exit(0)
if (depodaki < 38400000):
    print("fly")
...
if (kimin == f"slide/profile/{rr_id}" or market_fiyati < 2950): # bizim ya da fiyat dusuk
    ...
    if (ekle_or_degistir == "m"):
        ...
        if (kimin==f"slide/profile/{other_id}"):
            print("zaten bizim, gec...")
            sys.exit(0)
        ...
        if (offre_inp < 38400000 and offre_inp+depodaki < 38400000):
            miktar = offre_inp+depodaki
        else: miktar = 38400000
    ...
    'method': 'POST',
    'path': f'/storage/newsell/21/{miktar}/{fiyat}',
    'scheme': 'https',
    'Accept' : 'text/html, */*; q=0.01',
    'Accept-Encoding' : 'gzip, deflate, br, zstd',
    'Accept-Language' : 'tr-TR,tr;q=0.9,en-US;q=0.8,en;q=0.7,fr;q=0.6',
    ...
    url3 = "https://rivalregions.com/storage/newsell/21/" + str(miktar) + "/" + str(fiyat)
