...
url1 = "https://rivalregions.com/storage/market/27"
url2 = "https://rivalregions.com/storage/sell/27"
...
span = soup_main.find("span", class_="storage_number_change", attrs={'url': '27'}).text
...
#print(soup_1.findAll("span", class_="dot"))
market_fiyati = int(soup_1.findAll("span", class_="dot")[4].text[:-2].replace(".",""))
print("Guncel market fiyati: ", market_fiyati)
print(soup_1.find("span", class_="storage_sell dot"))
ekle_or_degistir = soup_1.find("span", class_="storage_sell dot").text[:1]

if (ekle_or_degistir == "y" and depodaki == 0): 
    print("ERROR: Depo bos ve teklifte kaynak yok, program kapatiliyor...")
    #print("Stop")
    sys.exit(0)
    #break # depo bos ve offre yok

if (kimin == "slide/profile/2001352321" or market_fiyati < 198000000): # bizim ya da fiyat dusuk
    ...
    if (ekle_or_degistir == "t"):
        print("teklifi degistir")
        ...
        if (offre_inp < 256000 and offre_inp+depodaki < 256000):
    ...
    url3 = "https://rivalregions.com/storage/newsell/27/" + str(miktar) + "/" + str(fiyat)
